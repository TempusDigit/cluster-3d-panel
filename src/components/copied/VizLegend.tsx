...
import { SeriesVisibilityChangeBehavior, SeriesVisibilityChangeMode, VizLegendItem, usePanelContext } from '@grafana/ui';
...
export function VizLegend<T>({
  ...
  const { eventBus, onToggleLegendSort } = usePanelContext();
